...
// Las citas se gestionan en Booksy, no en esta web.
const BOOKSY_URL = "https://booksy.com/es-es/93198_diamond-beauty_salon-de-unas_52925_alcobendas";
    ...
    html += `
      <div class="service-row">
        ...
        <span class="service-row__meta">
          ...
          <a href="${BOOKSY_URL}" target="_blank" rel="noopener" class="service-row__book" aria-label="Reservar ${item.name} en Booksy">
